...
const translations = {
  en: {
    ...
    register_subtitle: 'Just an email and password — explore the app right away.',
    register_name: 'Full Name',
    register_email: 'Email address',
    register_password: 'Password',
    register_confirm: 'Confirm Password',
    register_btn: 'Create Account & Start',
  ...
  ka: {
    ...
    register_title: 'შექმენი უფასო ანგარიში',
    register_subtitle: 'მხოლოდ ელ-ფოსტა და პაროლი — დაიწყე აპის გამოყენება მაშინვე.',
    register_name: 'სახელი და გვარი',
    register_email: 'ელ-ფოსტა',
    register_password: 'პაროლი',
    register_confirm: 'პაროლის დადასტურება',
    register_btn: 'ანგარიშის შექმნა და დაწყება',
