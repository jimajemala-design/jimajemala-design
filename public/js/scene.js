...
const FoodScene = (() => {
  ...
  // Keys are real food IDs (see server.js `foods` array, no underscores);
  // file names use underscores. Alias keys (eggs/blueberries/walnuts/cherries/
  // salmon) point at the same model so future ID variants still resolve.
  // NB: `pear` is intentionally absent — its source model exceeded the size
  // budget and was skipped, so pear falls back to the procedural mesh.
  const GLB_OVERRIDES = {
    apple:        '/models/apple.glb',
    banana:       '/models/banana.glb',
    chicken:      '/models/chicken.glb',
    salmon:       '/models/salmon.glb',
    ...
    blueberries:  '/models/blueberry.glb',
    greekyogurt:  '/models/greek_yogurt.glb',
    carrot:       '/models/carrot.glb',
    edamame:      '/models/edamame.glb',
    whey:         '/models/whey_protein.glb',
    shrimp:       '/models/shrimp.glb',
    beef:         '/models/beef.glb',
    tuna:         '/models/tuna.glb',
    whiterice:    '/models/white_rice.glb',
    buckwheat:    '/models/buckwheat.glb',
    corntortilla: '/models/corn_tortilla.glb',
    blackbeans:   '/models/black_beans.glb',
    pasta:        '/models/pasta.glb',
    ginger:       '/models/ginger.glb',
    kiwi:         '/models/kiwi.glb',
    darkchocolate:'/models/dark_chocolate.glb',
    garlic:       '/models/garlic.glb',
    tomato:       '/models/tomato.glb',
    walnut:       '/models/walnut.glb',
    walnuts:      '/models/walnut.glb',
    pomegranate:  '/models/pomegranate.glb',
    orange:       '/models/orange.glb',
    peach:        '/models/peach.glb',
    strawberry:   '/models/strawberry.glb',
    pineapple:    '/models/pineapple.glb',
    mango:        '/models/mango.glb',
    mussels:      '/models/mussels.glb',
    beefliver:    '/models/beef_liver.glb',
    hempseeds:    '/models/hemp_seeds.glb',
    duck:         '/models/duck_breast.glb',
    octopus:      '/models/octopus.glb',
    tofu:         '/models/tofu.glb',
    cannedsalmon: '/models/canned_salmon.glb',
    lamb:         '/models/lamb.glb',
    sardines:     '/models/sardines.glb',
    dragonfruit:  '/models/dragon_fruit.glb',
    coconut:      '/models/coconut.glb',
    passionfruit: '/models/passion_fruit.glb',
    lychee:       '/models/lychee.glb',
    plum:         '/models/plum.glb',
    apricot:      '/models/apricot.glb',
    blackberries: '/models/blackberries.glb',
    raspberries:  '/models/raspberries.glb',
    fig:          '/models/fig.glb',
    papaya:       '/models/papaya.glb',
    cherry:       '/models/cherry.glb',
    cherries:     '/models/cherry.glb',
  };
